...
Task: 
A series of hydrothermal vents form lines on a grid. Determine all points where lines overlap, but consider only horizontal and vertical lines.
"""
def getLines():
	"""
...
def main():
	...
	####A seperate process is used for horizontal lines and vertical lines, to achieve the same result.
	#print(inLines)
	for line in inLines:
