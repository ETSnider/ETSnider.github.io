def read_data2():
	d={}
	dist={}
	for i,l in enumerate(open('day15puzzle1input.txt')):
...
def writeRiskMap(riskMap):
	"""
	Added by ETSnider, for use in debugging day15puzzle1.py
	"""
	with open("puzzle1outother.txt","w") as f:
		for line in riskMap:
...
def partX(p2=False):
	if p2:
		...
		d = [[int(i) for i in l.strip()] for l in open('day15puzzle1input.txt')]
	to_do_list = [(0,0)]
