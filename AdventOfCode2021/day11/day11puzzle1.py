...
Given an array of octopi, find the number of flashes after 100 steps.
"""
...
def main():
	...
	octolist = OctoArray()
	#print(octolist)
	###Next, iterate through 100 steps
	for i in range(100):
		#print(f"step {i + 1}")
		octolist.Step()
		#print(octolist)
	###Then output the flash count to the console
	print(octolist.flashCount)
