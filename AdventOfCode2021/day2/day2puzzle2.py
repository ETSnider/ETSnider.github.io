...
Task:
Given a series of commands to a submarine, calculate its aim, position and depth, and calculate the depth times the horizontal position.
Commands: 
"up X" - subtract X from aim
"down X" - add X to aim
"forward X" - add X to horizontal position, and add X times aim to depth
"""
def main():
