...
if part_one:
    ...
    current_state.rooms[3].pos = [B, D]
    current_state.rooms[5].pos = [A, A]
    current_state.rooms[7].pos = [C, C]
# Part 2
else:
    current_state.rooms[1].pos = [D, D, D, B]
    current_state.rooms[3].pos = [B, C, B, D]
    current_state.rooms[5].pos = [A, B, A, A]
    current_state.rooms[7].pos = [C, A, C, C]
